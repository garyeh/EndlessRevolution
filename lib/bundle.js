...
class Game {
  ...
  play(difficulty) {
    ...
    this.t1 = setTimeout(() => {
      ...
      if (this.life > 0) {
<<<<<<< HEAD
        this.myInt = setInterval( randomGen, 10500 / 3 / speed);
=======
...
>>>>>>> master
    ...
    this.t2 = setTimeout(() => {
      ...
      if (this.life > 0) {
<<<<<<< HEAD
        this.myInt = setInterval( randomGen, 17500 / 3 / speed);
=======
        this.myInt = setInterval( randomGen, 10000 / 3 / speed);
>>>>>>> master
      }
    }, 105000);
    ...
    this.t3 = setTimeout(() => {
      ...
      if (this.life > 0) {
<<<<<<< HEAD
        this.myInt = setInterval( randomGen, 28000 / 3 / speed);
=======
        this.myInt = setInterval( randomGen, 13000 / 3 / speed);
      }
    }, 157500);
    ...
    this.t4 = setTimeout(() => {
      clearInterval(this.myInt);
      if (this.life > 0) {
        this.myInt = setInterval( randomGen, 17000 / 3 / speed);
>>>>>>> master
      }
    }, 210000);
